...
struct EditProfileView: View {
    ...
    var passwordField: some View {
            ...
            HStack {
                textField(placeholder: passwordPlaceholder, input: $passwordInput, isEmpty: true)
    ...
    var passwordEditButton: some View {
        Button {
           
            if editpasswordText == "Edit" {
                self.editpasswordText = "Done"
                self.passwordEnabled = false
                self.passwordPlaceholder = ""
                self.passwordInput = viewModel.password
            } else {
                self.viewModel.password = passwordInput
                self.editpasswordText = "Edit"
